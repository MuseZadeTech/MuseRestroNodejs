...
var controller = require('./dishoption.controller');
...
router.get('/global/options', auth.isAuthenticated(),controller.getGlobalOptions);
router.get('/store/options/getstoreowner',auth.isAuthenticated(), controller.getListStoreOptions);
